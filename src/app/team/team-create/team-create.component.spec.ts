...
describe('TeamCreateComponent', () => {
  ...
  it('should create a team', () => {
    ...
    spyOn(component.profileService, 'getProfile').and.returnValue(of([]));

    spyOn(component.projectService, 'getProjects').and.returnValue(of([mockProject]));
    ...
    component.createTeam(component.teamForm.value);
